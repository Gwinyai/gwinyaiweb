      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <p className={styles.description}>
            I am a full stack developer specializing in web and mobile applications. 
            My current passion is building AI apps, agents and systems.
          </p>
          <div className={styles.socialIcons}>
            ...
            <a href="https://stackoverflow.com" target="_blank" rel="noopener noreferrer" className={styles.iconLink} aria-label="Stack Overflow">
              <svg viewBox="0 0 24 24" className={styles.icon}>
            ...
            <a href="https://fiverr.com" target="_blank" rel="noopener noreferrer" className={styles.iconLink} aria-label="Fiverr">
              <Image
                src="/fiverrsmall.svg"
                alt="Fiverr"
                width={36}
